...
plt.title('Maximum Dropdown per Period for 2019-2020', fontsize = 20)
...
plt.title('Dynamic Change Value Weight for Minimum Variance Strategy',fontsize=15)
...
plt.xlabel('Trading Periods', fontsize=12)
plt.ylabel('Portfolio Weight Proportion',fontsize=12)
plt.title('Dynamic Change of Value Weight for Maximum Sharpe Ratio',fontsize=15)
...
plt.xlabel('Trading Periods', fontsize=12)
plt.ylabel('Portfolio Weight Proportion',fontsize=12)
plt.title('Dynamic Change of Share Unit Weight for Maximum Sharpes Ratio Strategy',fontsize=25)
...
plt.xlabel('Trading Periods', fontsize=12)
plt.ylabel('Portfolio Weight Proportion',fontsize=12)
plt.title('Dynamic Change of Value Weight for Robust Optimization',fontsize=15)       
...
plt.xlabel('Trading Periods', fontsize=12)
plt.ylabel('Portfolio Weight Proportion',fontsize=12)
plt.title('Dynamic Change of Share Unit Weight for Robust Optimization',fontsize=25)
